...
$mod_strings = array(
	...
	'LBL_SYSOPTS_2'                     => 'What type of database will be used for the SuiteASSURED instance you are about to install?',
	...
	'ERR_ADMIN_USER_NAME_BLANK'         => 'Provide the user name for the SuiteASSURED admin user. ',
	'ERR_ADMIN_PASS_BLANK'				=> 'Provide the password for the SuiteASSURED admin user. ',

	'ERR_CHECKSYS'                      => 'Errors have been detected during compatibility check. In order for your SuiteASSURED Installation to function properly, please take the proper steps to address the issues listed below and either press the recheck button, or try installing again.',
	'ERR_CHECKSYS_CALL_TIME'            => 'Allow Call Time Pass Reference is On (this should be set to Off in php.ini)',
	'ERR_CHECKSYS_CURL'					=> 'Not found: SuiteASSURED Scheduler will run with limited functionality.',
	...
	'ERR_CHECKSYS_PHP_INVALID_VER'		=> 'Your version of PHP is not supported by SuiteASSURED. You will need to install a version that is compatible with the SuiteASSURED application. Please consult the Compatibility Matrix in the Release Notes for supported PHP Versions. Your version is ',
	'ERR_CHECKSYS_IIS_INVALID_VER'      => 'Your version of IIS is not supported by SuiteASSURED. You will need to install a version that is compatible with the SuiteASSURED application. Please consult the Compatibility Matrix in the Release Notes for supported IIS Versions. Your version is ',
	'ERR_CHECKSYS_FASTCGI'              => 'We detect that you are not using a FastCGI handler mapping for PHP. You will need to install/configure a version that is compatible with the SuiteASSURED application. Please consult the Compatibility Matrix in the Release Notes for supported Versions. Please see <a href="http://www.iis.net/php/" target="_blank">http://www.iis.net/php/</a> for details ',
	...
	'ERR_CHECKSYS_ZLIB'					=> 'ZLib support not found: SuiteASSURED reaps enormous performance benefits with zlib compression.',
	'ERR_CHECKSYS_ZIP'					=> 'ZIP support not found: SuiteASSURED needs ZIP support in order to process compressed files.',
	'ERR_CHECKSYS_PCRE'					=> 'PCRE library not found: SuiteASSURED needs PCRE library in order to process Perl style of regular expression pattern matching.',
	'ERR_CHECKSYS_PCRE_VER'				=> 'PCRE library version: SuiteASSURED needs PCRE library 7.0 or above to process Perl style of regular expression pattern matching.',
	...
	'ERR_DB_EXISTS_WITH_CONFIG'			=> 'Database already exists with config data. To run an install with the chosen database, please re-run the install and choose: "Drop and recreate existing SuiteASSURED tables?"  To upgrade, use the Upgrade Wizard in the Admin Console. Please read the upgrade documentation located <a href="http://www.suitecrm.com" target="_new">here</a>.',
	...
	'ERR_DB_MYSQL_VERSION'				=> 'Your MySQL version (%s) is not supported by SuiteASSURED. You will need to install a version that is compatible with the SuiteASSURED application. Please consult the Compatibility Matrix in the Release Notes for supported MySQL versions.',
	...
	'ERR_DB_PASSWORD'					=> 'The passwords provided for the SuiteASSURED database administrator do not match. Please re-enter the same passwords in the password fields.',
	...
	'ERR_DB_USER_EXISTS'				=> 'User name for SuiteASSURED database user already exists -- cannot create another one with the same name. Please enter a new user name.',
	'ERR_DB_USER'						=> 'Enter a user name for the SuiteASSURED database administrator.',
	'ERR_DBCONF_VALIDATION'				=> 'Please fix the following errors before proceeding:',
	'ERR_DBCONF_PASSWORD_MISMATCH'      => 'The passwords provided for the SuiteASSURED database user do not match. Please re-enter the same passwords in the password fields.',
	...
	'ERR_PASSWORD_MISMATCH'				=> 'The passwords provided for the SuiteASSURED admin user do not match. Please re-enter the same passwords in the password fields.',
	...
	'ERR_PERFORM_NO_TCPIP'				=> '<b>We could not detect an Internet connection.</b> When you do have a connection, please visit <a href="http://www.suitecrm.com/">http://www.suitecrm.com/</a> to register with SuiteASSURED. By letting us know a little bit about how your company plans to use SuiteASSURED, we can ensure we are always delivering the right application for your business needs.',
	...
	'ERR_URL_BLANK'						=> 'Provide the base URL for the SuiteASSURED instance.',
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'The uploaded file is not compatible with this version of SuiteASSURED: ',

	'LBL_BACK'							=> 'Back',
	'LBL_CANCEL'                        => 'Cancel',
	'LBL_ACCEPT'                        => 'I Accept',
	'LBL_CHECKSYS_1'					=> 'In order for your SuiteASSURED installation to function properly, please ensure all of the system check items listed below are green. If any are red, please take the necessary steps to fix them.<BR><BR> For help on these system checks, please visit the <a href="http://www.suitecrm.com" target="_blank">SuiteASSURED</a>.',
	...
	'LBL_CHECKSYS_CONFIG'				=> 'Writable SuiteASSURED Configuration File (config.php)',
	'LBL_CHECKSYS_CONFIG_OVERRIDE'		=> 'Writable SuiteASSURED Configuration File (config_override.php)',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Caution: All SuiteASSURED data will be erased<br>if this box is checked.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Drop and Recreate Existing SuiteASSURED tables?',
	'LBL_DBCONF_DB_DROP'                => 'Drop Tables',
	'LBL_DBCONF_DB_NAME'				=> 'Database Name',
	'LBL_DBCONF_DB_PASSWORD'			=> 'SuiteASSURED Database User Password',
	'LBL_DBCONF_DB_PASSWORD2'			=> 'Re-enter SuiteASSURED Database User Password',
	'LBL_DBCONF_DB_USER'				=> 'SuiteASSURED Database User',
	'LBL_DBCONF_SUGAR_DB_USER'          => 'SuiteASSURED Database User',
	...
	'LBL_DBCONFIG_MSG3'                 => 'Name of the database that will contain the data for the SuiteASSURED instance you are about to install:',
	'LBL_DBCONFIG_MSG3_LABEL' => 'Database Name',
	'LBL_DBCONFIG_B_MSG1'               => 'The username and password of a database administrator who can create database tables and users and who can write to the database is necessary in order to set up the SuiteASSURED database.',
	'LBL_DBCONFIG_B_MSG1_LABEL' => '',
	'LBL_DBCONFIG_SECURITY'             => 'For security purposes, you can specify an exclusive database user to connect to the SuiteASSURED database. This user must be able to write, update and retrieve data on the SuiteASSURED database that will be created for this instance. This user can be the database administrator specified above, or you can provide new or existing database user information.',
	...
	'LBL_DISABLED_HELP_1'				=> 'For installation help, please visit the SuiteASSURED',
	'LBL_DISABLED_HELP_LNK'             => 'http://www.suitecrm.com/forum/index',
	'LBL_DISABLED_HELP_2'				=> 'support forums',
	'LBL_DISABLED_TITLE_2'				=> 'SuiteASSURED Installation has been Disabled',
	'LBL_DISABLED_TITLE'				=> 'SuiteASSURED Installation Disabled',
	...
	'LBL_LANG_1'						=> 'To use a language in SuiteASSURED other than the default language (US-English), you can upload and install the language pack at this time. You will be able to upload and install language packs from within the SuiteASSURED application as well. If you would like to skip this step, click Next.',
	...
	'LBL_LAUNCHING_SILENT_INSTALL'     => 'Installing SuiteASSURED now. This may take up to a few minutes.',
	...
	'LBL_LICENSE_TITLE_2'				=> 'SuiteASSURED License',
	...
	'LBL_LOCALE_DESC'					=> 'The specified locale settings will be reflected globally within the SuiteASSURED instance.',
	...
	'LBL_PERFORM_CONFIG_PHP'			=> 'Creating SuiteASSURED configuration file',
	...
	'LBL_PERFORM_CREATE_DEFAULT'		=> 'Creating default SuiteASSURED data',
	'LBL_PERFORM_CREATE_LOCALHOST'		=> 'Creating the Database username and password for localhost...',
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'Creating SuiteASSURED relationship tables',
	...
	'LBL_PERFORM_OUTRO_1'				=> 'The setup of SuiteASSURED ',
	...
	'LBL_PERFORM_TABLES'				=> 'Creating SuiteASSURED application tables, audit tables and relationship metadata',
	'LBL_PERFORM_TITLE'					=> 'Perform Setup',
	'LBL_PRINT'							=> 'Print',
	'LBL_REG_CONF_1'					=> 'Please complete the short form below to receive product announcements, training news, special offers and special event invitations from SuiteASSURED. We do not sell, rent, share or otherwise distribute the information collected here to third parties.',
	...
	'LBL_REG_CONF_3'					=> 'Thank you for registering. Click on the Finish button to login to SuiteASSURED. You will need to log in for the first time using the username "admin" and the password you entered in step 2.',
	'LBL_REG_TITLE'						=> 'Registration',
	'LBL_REG_NO_THANKS'                 => 'No Thanks',
	'LBL_REG_SKIP_THIS_STEP'            => 'Skip this Step',
	'LBL_REQUIRED'						=> '* Required field',

	'LBL_SITECFG_ADMIN_Name'            => 'SuiteASSURED Application Admin Name',
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Re-enter SuiteASSURED Admin User Password',
	'LBL_SITECFG_ADMIN_PASS_WARN'		=> 'Caution: This will override the admin password of any previous installation.',
	'LBL_SITECFG_ADMIN_PASS'			=> 'SuiteASSURED Admin User Password',
	'LBL_SITECFG_APP_ID'				=> 'Application ID',
	'LBL_SITECFG_CUSTOM_ID_DIRECTIONS'	=> 'If selected, you must provide an application ID to override the auto-generated ID. The ID ensures that sessions of one SuiteASSURED instance are not used by other instances. If you have a cluster of SuiteASSURED installations, they all must share the same application ID.',
	'LBL_SITECFG_CUSTOM_ID'				=> 'Provide Your Own Application ID',
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'If selected, you must specify a log directory to override the default directory for the SuiteASSURED log. Regardless of where the log file is located, access to it through a web browser will be restricted via an .htaccess redirect.',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Use a Custom Log Directory',
	'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS'	=> 'If selected, you must provide a secure folder for storing SuiteASSURED session information. This can be done to prevent session data from being vulnerable on shared servers.',
	'LBL_SITECFG_CUSTOM_SESSION'		=> 'Use a Custom Session Directory for SuiteASSURED',
	...
	'LBL_SITECFG_SUGAR_UPDATES'			=> 'SuiteASSURED Updates Config',
	...
	'LBL_SITECFG_URL'					=> 'URL of SuiteASSURED Instance',
	'LBL_SITECFG_USE_DEFAULTS'			=> 'Use Defaults?',
	'LBL_SITECFG_ANONSTATS'             => 'Send Anonymous Usage Statistics?',
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'  => 'If selected, SuiteASSURED will send <b>anonymous</b> statistics about your installation to SuiteASSURED Inc. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
	'LBL_SITECFG_URL_MSG'               => 'Enter the URL that will be used to access the SuiteASSURED instance after installation. The URL will also be used as a base for the URLs in the SuiteASSURED application pages. The URL should include the web server or machine name or IP address.',
	'LBL_SITECFG_SYS_NAME_MSG'          => 'Enter a name for your system. This name will be displayed in the browser title bar when users visit the SuiteASSURED application.',
	'LBL_SITECFG_PASSWORD_MSG'          => 'After installation, you will need to use the SuiteASSURED admin user (default username = admin) to log in to the SuiteASSURED instance. Enter a password for this administrator user. This password can be changed after the initial login. You may also enter another admin username to use besides the default value provided.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_1'						=> 'This installer creates the SuiteASSURED database tables and sets the configuration variables that you need to start. The entire process should take about ten minutes.',
	...
	'REQUIRED_SYS_COMP_MSG' =>
		'Before you begin, please be sure that you have the supported versions of the following system components:<br>
                      ...
                      compatible system components for the SuiteASSURED version that you are installing.<br>',
	'REQUIRED_SYS_CHK' => 'Initial System Check',
	'REQUIRED_SYS_CHK_MSG' =>
		'When you begin the installation process, a system check will be performed on the web server on which the SuiteASSURED files are located in order to
                      ...
                      <li>The following SuiteASSURED files must be writeable:<ul><li><b>/custom</li>
                      <li>/cache</li>
                      <li>/modules</li>
	...
	'REQUIRED_INSTALLTYPE_MSG' =>
		'After the system check is performed, you can choose either
                      ...
                      <ul>
                      <li> <b>Type of database</b> that will house the SuiteASSURED data <ul><li>Compatible database
                      ...
                      <ul><li>This may be <i>localhost</i> if the database is on your local computer or is on the same web server or machine as your SuiteASSURED files.<br><br></li></ul></li>
                      <li><b>Name of the database</b> that you would like to use to house the SuiteASSURED data</li>
                        <ul>
                          ...
                          be dropped during installation when the schema for the SuiteASSURED database is defined.</li>
                      ...
                      <li> <b>SuiteASSURED database user name and password</b>
                      </li>
                        <ul>
                      ...
                      <ul>
                      <li> <b>URL that will be used to access the SuiteASSURED instance</b> after it is installed.
                      This URL should include the web server or machine name or IP address.<br><br></li>
                                  ...
                                  session directory for SuiteASSURED information in order to prevent session data from
                                  being vulnerable on shared servers.<br><br></li>
                                  <li> [Optional] <b>Path to a custom log directory</b> if you wish to override the default directory for the SuiteASSURED log.<br><br></li>
                                  <li> [Optional] <b>Application ID</b> if you wish to override the auto-generated
                                  ID that ensures that sessions of one SuiteASSURED instance are not used by other instances.<br><br></li>
	...
	'LBL_WELCOME_TITLE_WELCOME'			=> 'Welcome to the SuiteASSURED ',
	'LBL_WELCOME_TITLE'					=> 'SuiteASSURED Setup Wizard',
	'LBL_WIZARD_TITLE'					=> 'SuiteASSURED Setup Wizard: ',
	'LBL_YES'							=> 'Yes',
	...
	'LBL_OOTB_SUGARFEEDS'   => 'Prune SuiteASSURED Feed Tables',
	...
	'LBL_SESSION_ERR_DESCRIPTION'		=> "SuiteASSURED relies upon PHP sessions to store important information while connected to this web server. Your PHP installation does not have the Session information correctly configured.
	...
	'LBL_REQUIRED_SYSTEM_NAME'=>'Provide a System Name for the SuiteASSURED instance.',
...
$contact_user_link_guid',
	...
	'LBL_WIZARD_SMTP_DESC' => 'Provide the email account that will be used to send emails, such as the assignment notifications and new user passwords. Users will receive emails from SuiteASSURED, as sent from the specified email account.',
	...
	'LBL_WIZARD_SYSTEM_DESC' => 'Provide your organization\'s name and logo in order to brand your SuiteASSURED.',
	...
	'CURRENT_LOGO_HELP'=>'This logo is displayed in the left-hand corner of the footer of the SuiteASSURED application.',
	...
	'LBL_WIZARD_LOCALE_DESC' => 'Specify how you would like data in SuiteASSURED to be displayed, based on your geographical location. The settings you provide here will be the default settings. Users will be able set their own preferences.',
